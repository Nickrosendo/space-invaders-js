...
function reset() {
  ...
  ship.shot.body.className = ship.shot.body.className.split('animate-ship-shot')[0]
  aliens[1].body.style.right = position + 'px'
  clearInterval(alien1MoveInterval)
  aliens[1].shot.body.className= aliens[1].shot.body.className.split('animate-alien-shot')[0]
}
